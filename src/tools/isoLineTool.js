...
import { getIsoSpacingWorld, snapWorldToIsoGrid } from "../core/isoGrid.js";
...
export class IsoLineTool extends BaseTool {
  ...
  getSnappedPoint(worldPoint) {
    ...
    if (appState.snapToGrid) {
      const gridCandidate = snapWorldToIsoGrid(worldPoint, getIsoSpacingWorld(appState.gridSpacing));
